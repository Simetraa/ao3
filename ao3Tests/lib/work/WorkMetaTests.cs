...
namespace ao3Tests.lib.work
{
    ...
    public class WorkMetaTests
    {
        ...
        public async Task DownloadTest()
        {
            ...
            var fileName = await work.Download(DownloadType.PDF, "%id%-%author%-%title%-%language%-%words%.%ext%");
